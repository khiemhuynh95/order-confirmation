      ...
      <div id="page-container">
         <div id="pf2" class="pf w0 h0" data-page-no="2">
            <div class="pc pc2 w0 h0">
               <img class="bi x0 y0 w1 h0" alt="" src="https://raw.githack.com/khiemhuynh95/order-confirmation/master/public/images/bg2.png"/>
               <div class="c x9 y1 w4 h1">
                  ...
                  <div class="t m0 xb h8 y11 ff4 fs5 fc3 sc0 ls11 ws0">Date/Time:<span class="ls12">{time}</span></div>
                  ...
                  <div class="t m0 x4 h9 y1d ff3 fs5 fc3 sc0 ls21 ws0">Credit Card Number:<span class="ls22">xxxxxxxxxxxx{cc#}</span></div>
                  <div class="t m0 x4 h9 y1e ff3 fs5 fc3 sc0 ls23 ws0">Reference Number:<span class="ls24">{ref#}</span></div>
                  <div class="t m0 x4 h9 y1f ff3 fs5 fc3 sc0 ls25 ws0">Card Type:<span class="ls26">Discover</span></div>
                  <div class="t m0 x4 h9 y20 ff3 fs5 fc3 sc0 ls27 ws0">Dev Info:<span class="ls28">XXXXXX{dev#}</span></div>
                  <div class="t m0 x4 h9 y21 ff3 fs5 fc3 sc0 ls29 ws0">Additional Amount:<span class="ls2a">---</span></div>
                  <div class="t m0 x4 h9 y22 ff3 fs5 fc3 sc0 ls2b ws0">Processor Transaction ID:<span class="ls2c">{transaction#}</span></div>
                  <div class="t m0 x4 h9 y23 ff3 fs5 fc3 sc0 ls2d ws0">Approval Code:<span class="ls2e">{app_code}</span></div>
                  ...
                  <div class="t m0 x4 h9 y29 ff3 fs5 fc3 sc0 ls37 ws0">Shipping Information:<span class="lse">{shipping#}</span></div>
                  ...
                  <div class="t m0 xa h9 y2e ff3 fs5 fc3 sc0 ls41 ws0">Primary Phone: +1 {phone#}<span class="_ _c"> </span><span class="ls40"> <span class="_ _a"> </span> <span class="_ _b"> </span> </span></div>
